...
def main():
    ...
    gs.tools.run_in_another_thread(fn=run_sim, args=(scene, args.vis, robot, target_left, target_right))
    if args.vis:
        scene.viewer.start()


def run_sim(scene, enable_vis, robot, target_left, target_right):
